# ServiceNow Table: Database (cmdb_ci_database)

**Category:** CORE
**SysID:** 367d2e8218f232108bb255f46a373ad6
...
| `db_server` | Database Server | reference | cmdb_ci_server | - |
| `sys_id` | Sys ID | GUID | - | - |
...
---
*Knowledge harvested by ServiceNow MCP v3.8.0 on 2026-03-29T19:25:13.643Z*