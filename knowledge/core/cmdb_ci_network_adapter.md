# ServiceNow Table: Network Adapter (cmdb_ci_network_adapter)

**Category:** CORE
**SysID:** 2dec268618b232108bb255f46a373a71
...
| `ip_default_gateway` | IP default gateway | ip_addr | - | - |
| `cmdb_ci` | Configuration Item | reference | cmdb_ci | - |
| `dhcp_enabled` | DHCP Enabled | boolean | - | - |
| `alias` | Alias | string | - | - |
| `sys_id` | Sys ID | GUID | - | - |
| `attested_date` | Attested Date | glide_date_time | - | - |
| `mac_manufacturer` | MAC Manufacturer | reference | core_company | - |
...
---
*Knowledge harvested by ServiceNow MCP v3.8.0 on 2026-03-29T19:25:14.907Z*